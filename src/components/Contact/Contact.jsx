...
function Contact() {
    ...
    return (
        <>
            <section className="h-auto w-screen scrollbar-hide">
                    ...
                    <div className="h-auto w-[100vw] m-auto flex justify-around flex-wrap-reverse pt-[4.5rem] sm:pt-[5.5rem] md:pt-[6rem] lg:pt-[7.8rem] xl:pt-[9rem] ">
                        <div className="h-auto ">
                            ...
                            <div className="h-[10rem] sm:h-[14rem] md:h-[16rem] lg:h-[18rem] xl:h-[20rem] w-auto sm:px-2 ">
                                ...
                                <div className="h-[1rem] sm:h-[1.5rem] md:h-[2rem] lg:h-[2.5rem] xl:h-[3rem] w-auto flex jusctify-center items-center mt-2">
                                    ...
                                    <span className="text-white text-[14px] sm:text-[18px] md:text-[20px] lg:text-[23px] xl:text-[24px] pl-4">+91- 9654853181</span>
                                </div>

                                <div className="h-[1rem] sm:h-[1.5rem] md:h-[2rem] lg:h-[2.5rem] xl:h-[3rem] w-auto flex jusctify-center items-center mt-2">
                                    <AiOutlineMail className="text-[15px] sm:text-[19px] md:text-[22px] lg:text-[24px] xl:text-[26px] text-white" />
                                    <span className="text-white text-[14px] sm:text-[18px] md:text-[20px] lg:text-[23px] xl:text-[24px] pl-4">rohitkumar9643017@gamil.com</span>
                                </div>
                                ...
                                <div className="h-[1rem] sm:h-[1.5rem] md:h-[2rem] lg:h-[2.5rem] xl:h-[3rem] w-auto flex jusctify-center sm:items-start xl:items-center lg:items-center mt-2">
                                    ...
                                    <span className="text-white text-[14px] sm:text-[18px]  md:text-[20px] lg:text-[23px] xl:text-[24px] pl-4">NH-19 (NH-2), Ballabgarh, Faridabad</span>
                                </div>
                        ...
                        <div className="h-auto w-[28rem] flex flex-col items-center ">
                            ...
                            <form className="mt-1 sm:mt-2  md:mt-4 lg:mt-6 xl:mt-7 w-full p-4 rounded-lg">
                                ...
                                ></textarea>
                            <button className=" h-[2rem] sm:h-[2.5rem] md:h-[2.7rem] lg:h-[3.2rem] xl:h-[3.5rem] w-full sm:text-[18px] md:text-[20px] lg:text-lg xl:text-lg rounded-sm sm:rounded-sm md:rounded-md lg:rounded-lg xl:rounded-lg pl-4 border outline-none border-none font-bold bg-[#FFB800] hover:bg-[#ffc739]">SUBMIT</button>
                            </form>
                        </div>
